	...
	<body style="margin: 15px auto; width: 100%;position:relative;">
		...
		var table = new Tabulator("#example-table", {
			...
			columns:[
				...
				{title:"Name", field:"name", sorter:"string", width:120},
				{title:"Created", field:"created", sorter:"date", mutator:changetimestamp2date, align:"center", width:190},
				{title:"Brand", field:"brand", sorter:"string", width:40},
				{title:"Country", field:"country", sorter:"string", width:40},
				{title:"Last 4 digit", field:"last4", width:70}
			],
		...
		table.setData("http://stripe.wasaike.com/customers.json", {}, ajaxConfig); //make ajax request with advanced config options
		</script>
	</body>
</html>
